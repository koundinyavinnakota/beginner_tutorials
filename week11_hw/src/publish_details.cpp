...
class DetailsPublisher : public rclcpp::Node {
 ...
 private:
   ...
   */
  void change_details(
      const std::shared_ptr<week11_hw::srv::Details::Request> request,
      std::shared_ptr<week11_hw::srv::Details::Response> response) {
  ...
  std::string frame_;
  rclcpp::Publisher<week11_hw::msg::Details>::SharedPtr details_publisher_;
